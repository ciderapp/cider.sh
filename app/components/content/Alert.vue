<!-- 
    GitHub Alerts Markdown Component
    Icons and Styling sourced from antfu/markdown-it-github-alerts
    @see: https://github.com/antfu/markdown-it-github-alerts
-->
...
<template>
    <div class="markdown-alert" :class="'markdown-alert-' + props.type">
        <p class="markdown-alert-title" dir="auto">
            ...
            <!-- Caution -->
            <template v-if="type === 'caution'">
                <svg class="octicon octicon-stop mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16"
                    aria-hidden="true">
                    <path
            ...
            <template v-if="type === 'warning'">
                <svg class="octicon octicon-alert mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16"
                    aria-hidden="true">
                    <path
