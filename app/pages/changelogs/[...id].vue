<template>
  <div class="flex flex-col items-center">
    ...
    <main v-else class="container grid grid-cols-1 lg:grid-cols-[290px_minmax(0,1fr)] lg:gap-10">
      ...
      <div class="sticky top-14 z-20 hidden h-[calc(100dvh-57px)] border-r text-card-foreground lg:block">
      ...
      <div class="xl:grid xl:grid-cols-[1fr,250px] xl:gap-5">
        ...
        <aside v-if="page && page.body && page.body.toc && page.body.toc.links.length > 0"
          ...
          <div class="p-5">
            ...
            <Suspense>
              <LazyDocsToclink :set-active="setActive" :active-id="activeId" :links="page.body.toc.links" />
              <template #fallback>
                <UiSkeleton class="h-[calc(100dvh-57px)] w-full" />
              </template>
            </Suspense>
...
useSeoMeta({
  ...
  ogImage: () => `https://github.com/ciderapp/changes/blob/main/1.client-releases/images/${page.value.image || "undefined"}?raw=true`,
});
</script>
